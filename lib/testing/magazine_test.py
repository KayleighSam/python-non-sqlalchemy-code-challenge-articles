...
class TestMagazine:
    ...
    def test_name_is_mutable_string(self):
        ...
        # Remove the direct mutation of `name` as it's immutable
        # Comment out the following block since name can't be changed:
        # magazine_1.name = "New Yorker"
        # assert magazine_1.name == "New Yorker"

        # Uncomment the exception handling for invalid name type or value
    ...
    def test_name_len(self):
        ...
        # Comment out the following lines if using Exceptions
        # magazine_1.name = "New Yorker Plus X"
        # assert magazine_1.name == "Vogue"

        # Uncomment the exception handling for invalid name length
        with pytest.raises(ValueError):
            magazine_1.name = "New Yorker Plus X"
    ...
    def test_category_is_mutable_string(self):
        ...
        # Remove the direct mutation of `category` as it's immutable
        # Comment out the following block since category can't be changed:
        # magazine_1.category = "Life Style"
        # assert magazine_1.category == "Life Style"

        # Uncomment the exception handling for invalid category type or value
        with pytest.raises(ValueError):
            Magazine("GQ", 2)
    ...
    def test_category_len(self):
        ...
        # Uncomment the exception handling for empty category
        with pytest.raises(ValueError):
            magazine_1.category = ""
